...
//       if (mobile) {
//         toast.warn(
//           "For the best experience, we recommend using a PC or Laptop",
//           {
//             position: "top-center",
//             autoClose: 2000,
...
//   return (
//     <div
//       className="bg-gray-950 spc text-white min-h-screen text-center  lg:overflow-hiden"
...
//             >
//               {/* <div className="w-full h-px bg-gradient-to-r from-transparent via-slate-700 to-transparent  my-16" /> */}
//               <Contact />
//               <Footer />
//             </motion.section>
//           </main>
...
const App = () => {
  ...
  // Loader timeout and mobile detection
  useEffect(() => {
